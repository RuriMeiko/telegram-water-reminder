...
async function tinhLuongNuocTheoBMI(canNang:number, chieuCao:number) {
    // @ts-ignore
    // @ts-ignore
    // @ts-ignore
    // @ts-ignore
...
async function sendMessage(text:string, chatId:number, inline_keyboard:any = undefined, save = false, parse_mode = 'HTML') {
    // @ts-ignore
...
async function editMessage(text:string, chatId:number, messageId:number, inline_keyboard:any = undefined, parse_mode = 'HTML') {
    // @ts-ignore
...
async function answerCallbackQuery(callbackQueryId:number, text = undefined, showAlert = false) {
    // @ts-ignore
